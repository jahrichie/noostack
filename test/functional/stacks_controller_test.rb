...
class StacksControllerTest < ActionController::TestCase
  ...
  test "should create stack" do
    assert_difference('Stack.count') do
      post :create, stack: { description: @stack.description, name: @stack.name, stack_id: @stack.stack_id }
    end
  ...
  test "should update stack" do
    put :update, id: @stack, stack: { description: @stack.description, name: @stack.name, stack_id: @stack.stack_id }
    assert_redirected_to stack_path(assigns(:stack))
  end
